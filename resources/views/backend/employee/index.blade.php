        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools mr-0">
                    @can('employee-create')
                    <a href="{{ route('admin.employee.create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus mx-1"></i> New employee </a>
                    @endcan
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="{{ route('admin.employee.index') }}" method="GET" autocomplete="off">
                            <div class="row mb-1">
                                ...
                                <div class="col-sm-2 form-group">
                                    <a href="{{ route('admin.employee.index') }}" class="btn btn-light">Reset</a>
                                </div>
                            </div>
                        </form>
                        @can('create-employee')
                        <a data-href="{{ route('admin.employee.create')}}" href="#" class="float-right btn btn-success btn-sm" id="newButton"><i class="fa fa-plus mx-1"></i> create employee</a>
                        @endcan
                    </div>
                </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="modal fade" id="ajaxModal" role="dialog" aria-hidden="true" style="margin-top: -2%;">
